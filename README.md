...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-kumaraswamy/tags). For example,

```javascript
kumaraswamy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-kumaraswamy@v0.2.2-umd/browser.js' )
```
